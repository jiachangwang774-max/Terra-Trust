...
<template>
   <header>
     ...
     <div class="nav">
         <RouterLink to="/firstPage" class="nav-item">首页</RouterLink>
         <RouterLink to="/myOrder"  class="nav-item">我的订单</RouterLink>
         <RouterLink to="/dashBoard"class="nav-item">后台</RouterLink>
