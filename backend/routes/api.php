...
Route::prefix('v1')->middleware('jwt.auth')->group(function () {
    ...
    // 抽检接口
    Route::post('/inspections', [WjcController::class, 'storeInspection']);
    Route::get('/purchaser/inspections', [WjcController::class, 'purchaserInspectionList']);
    Route::get('/orders/{order}/inspection', [WjcController::class, 'showInspectionByOrder']);
});
